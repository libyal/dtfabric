...
BYTE_ORDERS = frozenset(
    [BYTE_ORDER_BIG_ENDIAN, BYTE_ORDER_LITTLE_ENDIAN, BYTE_ORDER_NATIVE]
)
...
TYPE_INDICATOR_PADDING = "padding"
...
TYPE_INDICATOR_STRUCTURE_GROUP = "structure-group"
