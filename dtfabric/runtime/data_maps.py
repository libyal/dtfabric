...
class StorageDataTypeMap(DataTypeMap):
    ...
    def GetStructByteOrderString(self):
        ...
        return self._BYTE_ORDER_STRINGS.get(self._data_type_definition.byte_order, None)
...
class PrimitiveDataTypeMap(StorageDataTypeMap):
    ...
    def MapByteStream(self, byte_stream, byte_offset=0, context=None, **unused_kwargs):
        """Maps the data type on a byte stream.
...
class BooleanMap(PrimitiveDataTypeMap):
    ...
    def __init__(self, data_type_definition):
        ...
        """
        if (
            data_type_definition.false_value is None
            and data_type_definition.true_value is None
        ):
            raise errors.FormatError("Boolean data type has no True or False values.")
    ...
    def GetStructFormatString(self):
        ...
        Returns:
          str: format string as used by Python struct or None if format string
              cannot be determined.
        """
        return self._FORMAT_STRINGS.get(self._data_type_definition.size, None)
...
class ElementSequenceDataTypeMap(StorageDataTypeMap):
    ...
    def _EvaluateNumberOfElements(self, context):
        ...
        if self._data_type_definition.number_of_elements:
            ...
            try:
                # pylint: disable=eval-used
                number_of_elements = eval(expression, namespace)
            except Exception as exception:
                raise errors.MappingError(
    ...
    def _GetElementDataTypeMap(self, data_type_definition):
        ...
        if (
            ...
            and element_byte_order == definitions.BYTE_ORDER_NATIVE
            and not element_data_type_definition.IsComposite()
        ):
    ...
    def _HasElementsDataSize(self):
        ...
        """
        return (
            self._data_type_definition.elements_data_size is not None
            or self._data_type_definition.elements_data_size_expression is not None
        )
    ...
    def _HasNumberOfElements(self):
        ...
        """
        return (
            self._data_type_definition.number_of_elements is not None
            or self._data_type_definition.number_of_elements_expression is not None
        )
        ...
        if self._HasElementsDataSize():
            ...
            if number_of_elements is not None:
                ...
                if element_byte_size:
                    ...
                    if element_size_hint is not None:
                        elements_data_size = context_state.get(
                            "elements_data_offset", 0
                        )
                        elements_data_size += element_size_hint
...
class SequenceMap(ElementSequenceDataTypeMap):
    ...
    def __init__(self, data_type_definition):
        ...
        if (
            self._element_data_type_definition.IsComposite()
            or data_type_definition.elements_data_size_expression is not None
            or data_type_definition.elements_terminator is not None
            or data_type_definition.number_of_elements_expression is not None
        ):
    ...
    def _CompositeFoldByteStream(self, mapped_value, byte_offset=0, **unused_kwargs):
        """Folds the data type into a byte stream.
        ...
        **unused_kwargs,
        ...
        try:
            while byte_stream[byte_offset:]:
                if (
                    number_of_elements is not None
                    and element_index == number_of_elements
                ):
                    break

                if (
                    elements_data_size is not None
                    and elements_data_offset >= elements_data_size
                ):
                    break
                ...
                if (
                    elements_terminator is not None
                    and element_value == elements_terminator
                ):
                    break
        ...
        if (
            ...
            and element_value != elements_terminator
            and (
                elements_data_size is None or elements_data_offset < elements_data_size
            )
        ):
            context_state["context"] = subcontext
            context_state["element_index"] = element_index
...
class StreamMap(ElementSequenceDataTypeMap):
    ...
    def MapByteStream(self, byte_stream, byte_offset=0, context=None, **unused_kwargs):
        ...
        if elements_data_size is not None:
            ...
            elements_terminator = self._data_type_definition.elements_terminator
            element_value = byte_stream[elements_data_offset:next_elements_data_offset]
...
class StringMap(StreamMap):
    ...
    def MapByteStream(
        self, byte_stream, byte_offset=0, **kwargs
    ):  # pylint: disable=arguments-differ
        """Maps the data type on a byte stream.
...
class StructureMap(StorageDataTypeMap):
    ...
    def __init__(self, data_type_definition):
        ...
        self._operation = None
        self._structure_values_class = runtime.StructureValuesClassFactory.CreateClass(
            data_type_definition
        )
    ...
    def _CheckLinearMap(self, data_type_definition):
        ...
        for member_definition in members:
            if member_definition.IsComposite() or isinstance(
                member_definition, data_types.PaddingDefinition
            ):
            ...
            if (
                ...
                and member_definition.byte_order != definitions.BYTE_ORDER_NATIVE
                and last_member_byte_order != member_definition.byte_order
            ):
                supports_linear_map = False
                break
    ...
    def _CompositeFoldByteStream(self, mapped_value, context=None, **unused_kwargs):
        ...
        if not subcontext:
            subcontext = DataTypeMapContext(
                values={type(mapped_value).__name__: mapped_value}
            )
        ...
        for attribute_index in range(attribute_index, self._number_of_attributes):
            ...
            member_data = data_type_map.FoldByteStream(member_value, context=subcontext)
...
class SemanticDataTypeMap(DataTypeMap):
    ...
    def FoldByteStream(
        self, mapped_value, **unused_kwargs
    ...
    def MapByteStream(
        self, byte_stream, **unused_kwargs
    ):  # pylint: disable=redundant-returns-doc
        """Maps the data type on a byte stream.
