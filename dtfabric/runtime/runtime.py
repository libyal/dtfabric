...
class StructureValuesClassFactory:
    ...
    def _IsIdentifier(cls, string):
        ...
        return (
            string
            and not string[0].isdigit()
            and all(character.isalnum() or character == "_" for character in string)
        )
    ...
    def _ValidateDataTypeDefinition(cls, data_type_definition):
        ...
        for member_definition in members:
            ...
            if keyword.iskeyword(attribute_name):
                raise ValueError(f"Attribute name: {attribute_name!s} matches keyword")

            if attribute_name in defined_attribute_names:
                raise ValueError(f"Attribute name: {attribute_name!s} already defined")
    ...
    def CreateClass(cls, data_type_definition):
        ...
        namespace = {
            "__builtins__": {"object": builtins.object, "super": builtins.super},
