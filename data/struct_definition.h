/*
 * The ${struct_name_description} definition of a ${struct_description}
 *
...
#if !defined( _${prefix_upper_case}_${struct_name_upper_case} )_H
#define _${prefix_upper_case}_${struct_name_upper_case}_H
...
#endif /* !defined( _${prefix_upper_case}_${struct_name_upper_case}_H ) */
